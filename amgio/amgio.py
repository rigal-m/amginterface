...
def py_ReadMesh(MshNam, SolNam, pyVer, pyTri, pyTet, pyEdg, pySol, pySolHeader, pyMarkers):
    return _amgio.py_ReadMesh(MshNam, SolNam, pyVer, pyTri, pyTet, pyEdg, pySol, pySolHeader, pyMarkers)
py_ReadMesh = _amgio.py_ReadMesh

def py_WriteMesh(MshNam, SolNam, pyVer, pyTri, pyTet, pyEdg, pySol, pyMarkers, Dim):
    return _amgio.py_WriteMesh(MshNam, SolNam, pyVer, pyTri, pyTet, pyEdg, pySol, pyMarkers, Dim)
